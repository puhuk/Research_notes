...
from generator import MotionTransferGenerator
...
if __name__ == "__main__":
    ...
    if opt.checkpoint is not None:
        ...
        log_dir += '_' + strftime("%d-%m-%y_%H%M", gmtime())
    ...
    dense_motion_params={'block_expansion':32, 'max_features':1024, 'num_blocks':5}
